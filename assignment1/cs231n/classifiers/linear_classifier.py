...
class LinearClassifier(object):
    ...
    def train(self, X, y, learning_rate=1e-3, reg=1e-5, num_iters=100,
        ...
        - y: A numpy array of shape (N,) containing training labels;
            y[i] = c means that X[i] has label 0 <= c < C for C
            classes.
        ...
        for it in xrange(num_iters):
            ...
            # their corresponding labels to use in this round of     #
            # gradient descent. Store the data in X_batch and their  #
            # corresponding labels in y_batch; after sampling        #
            # X_batch should have shape (dim, batch_size) and        #
            # y_batch should have shape (batch_size,).               #
            #                                                        #
            # Hint: Use np.random.choice to generate indices.        #
            # Sampling with replacement is faster than sampling      #
            # without replacement.                                   #
            ##########################################################
    ...
    def predict(self, X):
        ...
        Inputs:
        - X: D x N array of training data. Each column is a
            D-dimensional point.
        ...
        ##############################################################
        # TODO:                                                      #
        # Implement this method. Store the predicted labels in       #
        # y_pred.                                                    #
        ##############################################################
    ...
    def loss(self, X_batch, y_batch, reg):
        ...
        - X_batch: A numpy array of shape (N, D) containing a
            minibatch of N data points; each point has dimension D.
